...
function addDepotCard() {
	$.ajax({
		type:'get',
		url:'${APP_PATH }/index/card/findAllCardType',
		datatype:'json',
		data:'',
...
function addDepotCardSubmit(){
	$.ajax({
		type:'post',
		url:'${APP_PATH }/index/card/addDepotCard',
		datatype:'json',
...
function alertCard(status) {
	...
	$.ajax({
		type:'get',
		url:'${APP_PATH }/index/card/findDepotCardByCardnum',
		datatype:'json',
...
function changeLoseCardSubmit()
{
	$.ajax({
		type:'post',
		url:'${APP_PATH }/index/card/changeLoseCard',
		datatype:'text',
		data:$("#checkForm").serializeArray(),
...
function isAlertType(){
	...
	$.ajax({
		type:'post',
		url:'${APP_PATH }/index/card/isAlertType',
		datatype:'text',
		async: false,
		data:$("#checkForm").serializeArray(),
		contentType:'application/x-www-form-urlencoded',
...
function alertDepotCardSubmit(){
	...
	$.ajax({
		type:'post',
		url:'${APP_PATH }/index/card/alertDepotCard',
		datatype:'json',
		data:$("#checkForm").serializeArray(),
		success:function(data){
			if(data.code==100)
...
function deleteDepotCardSubmit(status){
	...
	$.ajax({
		type:'post',
		url:'${APP_PATH }/index/card/deleteDepotCard',
		datatype:'text',
		data:{"cardnum":cardnum},
		contentType:'application/x-www-form-urlencoded',
		success:function(data){
...
if(money.trim()=="")
	...
	$.ajax({
		type:'post',
		url:'${APP_PATH }/index/card/findCoupon',
		datatype:'text',
		data:{"cardnum":cardnum},
		contentType:'application/x-www-form-urlencoded',
		success:function(data){
...
function rechargeDepotCardSubmit()
{
	...
	$.ajax({
		type:'post',
		url:'${APP_PATH }/index/card/rechargeDepotCardSubmit',
		datatype:'json',
		data:$("#checkForm").serializeArray(),
		success:function(data){
			if(data.code==100)
